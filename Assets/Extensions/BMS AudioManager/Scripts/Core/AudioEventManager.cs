...
public static class AudioEventManager
{
    ...
    public delegate void AudioEvent_PlayAmbientAudio_Track(Transform attachTo, int trackIndex, string trackName, float volume, float pitch, float spatialBlend, FadeType fadeType, float fadeDuration, FadeTarget fadeTarget, bool loop, string eventName);
    ...
    public delegate void AudioEvent_UpdateAmbientAudio_Track(Transform attachTo, float volume, float pitch, float spatialBlend, float fadeDuration, FadeTarget fadeTarget, bool loop, string eventName);
